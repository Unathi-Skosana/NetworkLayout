...
public class DigraphGenerator {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        switch(type) {
            case "binaryTree":
                Formatter BT = new Formatter(binaryTree(V), type);
                break;
            case "rooted-in DAG":
                Formatter rootedInDAG = new Formatter(rootedInDAG(V, E), type);
                break;
            case "rooted-out DAG":
                Formatter rootedOutDAG = new Formatter(rootedOutDAG(V, E), type);
                break;
            case "rooted-in tree":
                Formatter rootedInTree = new Formatter(rootedInTree(V), type);
                break;
            case "rooted-out tree":
                Formatter rootedOutTree = new Formatter(rootedOutTree(V), type);
                break;
            case "DAG":
                Formatter DAG = new Formatter(dag(V, E), type);
                break;
            case "tournament":
                Formatter tournament = new Formatter(tournament(V), type);
                break;
            default:
                String options = "binaryTree, rooted-in DAG, rooted-in DAG, rooted-in tree, rooted-out tree, DAG, tournament";
